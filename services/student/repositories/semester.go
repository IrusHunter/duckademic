...
type SemesterRepository interface {
	...
	ExternalUpdate(context.Context, uuid.UUID, entities.Semester) (entities.Semester, error)
}
...
func (r *semesterRepository) ExternalUpdate(
	ctx context.Context, id uuid.UUID, semester entities.Semester,
) (entities.Semester, error) {
	return r.UpdateFields(ctx, id, []string{"slug", "curriculum_id", "number"}, semester)
}
